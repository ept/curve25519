...
% TODO for revision:
% IES https://en.wikipedia.org/wiki/Integrated_Encryption_Scheme
% DHIES https://www.cs.ucdavis.edu/~rogaway/papers/dhies.pdf
% KEM https://words.filippo.io/dispatches/post-quantum-age/
...
% This paper, ported to Rust https://github.com/mikayla-maki/tweet_nacl_rust

% Other things to look at: NIST P-256 curve; Ed25519; secp256k1 ECDSA (bitcoin); petlib https://petlib.readthedocs.io/en/latest/
% Constant-time NIST curves implementation https://twitter.com/FiloSottile/status/1525133270479929344
% Deterministic ECDSA https://datatracker.ietf.org/doc/html/rfc6979
% Deterministic with additional randomness https://datatracker.ietf.org/doc/html/draft-mattsson-cfrg-det-sigs-with-noise-04
% Breaking ECDSA with less than one bit of nonce leakage https://eprint.iacr.org/2020/615

% Ed25519 to Curve25519 conversion https://blog.filippo.io/using-ed25519-keys-for-encryption/
...
% Edwards curves https://link.springer.com/chapter/10.1007/978-3-540-76900-2_3
...
% Problems with cofactors https://eprint.iacr.org/2019/526.pdf

% A graduate course in applied cryptography https://toc.cryptobook.us/
% (Chapter 15 introduces pairing-based elliptic curve cryptography)
% Another course: https://intensecrypto.org/public/index.html
...
% The Rust cryptography ecosystem: https://kerkour.com/blog/rust-cryptography-ecosystem/
...
% Vectorized montgomery ladder: https://eprint.iacr.org/2020/378
% Curve25519 on FPGA: https://dl.acm.org/doi/10.1145/3312742
% https://www.bunniestudios.com/blog/?p=6140
% "digits are your fingers, limbs (like your arms) hold multiple digits"
...
% Timing side-channel attack on base64 decoding: https://arxiv.org/pdf/2108.04600.pdf
% Side-channel even against constant-time code https://www.hertzbleed.com/
...
% Survey of use of constant-time algorithms: https://eprint.iacr.org/2021/1650.pdf
% Constant-time in BearSSL https://www.bearssl.org/constanttime.html

% Optimised addition chains for field inversion based on Fermat's little theorem:
% https://github.com/mmcloughlin/addchain

% EcGFp5: a specialised elliptic curve for STARK proofs https://github.com/pornin/ecgfp5/blob/main/doc/ecgfp5.pdf
% (uses field GF(p^5) where p is a 64-bit prime)
...
% Comparison of PAKEs by Feng Hao (author of J-PAKE): https://www.youtube.com/watch?v=ubiObUDGVng
% also table 1 in https://eprint.iacr.org/2021/839.pdf
...
% OPAQUE https://www.iacr.org/archive/eurocrypt2018/10822359/10822359.pdf
% OPAQUE DH-OPRF https://datatracker.ietf.org/doc/html/draft-krawczyk-cfrg-opaque-03
% Implementation used for WhatsApp e2e encrypted backups https://crates.io/crates/opaque-ke
...
% Pairing
% BLS12-381 curve is used for zero-knowledge proofs e.g. in Zcash, Eth2 https://hackmd.io/@benjaminion/bls12-381
...
% BLS signatures are used in Wendy BFT protocol https://eprint.iacr.org/2021/1308.pdf
% Identity-Based Encryption using pairing https://crypto.stanford.edu/~dabo/papers/bfibe.pdf
% https://eprint.iacr.org/2006/199.pdf
